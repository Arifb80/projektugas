         ...
         <?php } elseif ($destinasi == '7') { ?>
                  ...
                  <table>
                     ...
                     <div  class="cafe" align="center">
                           ...
                           <option value="3">Mie kuah</option>
                           <option value="4">ice dawet</option>
                           <option value="5">es vanila</option>
                           <option value="6">teh hijau</option>
                         </select>
